...
const navItems = [
  ...
  { label: "My Courses", icon: BookOpen, href: "/teacher/courses", active: false },
          ...
          <div className="mx-auto max-w-7xl space-y-6">
            <div>
              <div className="mb-4 flex items-center justify-between">
                ...
                <Link href="/teacher/submissions" className="text-xs font-medium text-slate-500 transition-colors duration-200 hover:text-slate-900">View all</Link>
              </div>
              <div className="divide-y divide-slate-200">
                {mockSubmissions.map((s) => <SubmissionCard key={s.id} submission={s} />)}
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between py-4">
                ...
                <Link href="/teacher/courses" className="text-xs font-medium text-slate-500 transition-colors duration-200 hover:text-slate-900">View all</Link>
              </div>
              <div className="divide-y divide-slate-200">
